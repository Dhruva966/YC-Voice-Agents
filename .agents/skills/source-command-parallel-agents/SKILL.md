---
name: "source-command-parallel-agents"
...
# source-command-parallel-agents

Use this skill when coordinating parallel implementation or review work across multiple Codex agents.
...
- Choose the smallest useful team before decomposing work.
- Establish a communication protocol before agents start editing shared boundaries.
