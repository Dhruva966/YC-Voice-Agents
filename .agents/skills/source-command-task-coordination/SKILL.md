---
name: "source-command-task-coordination"
...
# source-command-task-coordination

Use this skill when decomposing complex work into coordinated tasks for Codex agents.
...
### Capturing blocked-by/blocks

Use whatever task system is available to record dependencies. In plain Codex work, a short checklist is enough:

| Task | Blocks | Blocked by |
|------|--------|------------|
| Build API endpoints | Integration testing | - |
| Build frontend components | Integration testing | - |
| Integration testing | - | API endpoints, frontend components |
...
1. Inspect the current plan or task list
2. Identify idle or overloaded teammates
3. Reassign tasks in the available coordination surface
4. Notify affected teammates with the local agent messaging mechanism
